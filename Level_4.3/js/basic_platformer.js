...
function animate()
{
	...
	while(platform1.hitTestPoint(player.bottom()) && player.vy >=0)//player.vy >=0 assures that its velocity goes back down
	{
		player.y--;//player gets moved up
		player.vy = 0;
		player.canJump = true;//makes sure you can jump after going through the platforum
