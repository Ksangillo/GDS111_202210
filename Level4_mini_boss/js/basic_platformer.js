...
var player;
	...
	platform0 = new GameObject();
		...
		platform1.width = 300;
		platform1.x = platform1.width/2 + 300;
		platform1.y = canvas.height - platform1.height/2 - 150;
		platform1.color = "#66ff33";

		platform2 = new GameObject();
		platform2.width = 200;
		platform2.x = platform1.width/2 + 600;
		platform2.y = canvas.height - platform2.height/2 - 250;
		platform2.color = "#66ff33";

		platform3 = new GameObject();
		platform3.width = 200;
		platform3.x = platform1.width/2 + 800;
		platform3.y = canvas.height - platform3.height/2 - 350;
